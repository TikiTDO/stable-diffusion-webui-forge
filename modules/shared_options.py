...
options_templates.update(options_section(('sd', "Stable Diffusion", "sd"), {
    ...
    "sdxl_clip_l_skip": OptionInfo(False, "Clip skip SDXL", gr.Checkbox).info("Enable clip skip for SDXL's secondary CLIP model."),
...
options_templates.update(options_section(('ui_alternatives', "UI alternatives", "ui"), {
    ...
    "sd_checkpoint_dropdown_use_short": OptionInfo(False, "Checkpoint dropdown: use filenames without paths").info("models in subdirectories like illustration/model.safetensors will be listed as just model.safetensors"),
...
options_templates.update(options_section(('ui', "User interface", "ui"), {
    ...
    "tabs_without_quick_settings_bar": OptionInfo([], "UI tabs without Quicksettings bar (top row)", ui_components.DropdownMulti, lambda: {"choices": list(shared.tab_names)}),
